...
class DataOpManipulationTest(unittest.TestCase):
    def test_flatten(self):
        ...
        tt1 = tt.data_functions.flatten(tt0)
        shape = tt0.shape()
        self.assertTrue(shape[0] == 2)
        self.assertTrue(shape[1] == 3)
        shape = tt1.shape()
    ...
    def test_time_alignment(self):
        ...
        tt0_a, tt1_a = tt.time_functions.alignment(tt0, tt1)
    ...
    def test_split(self):
        n = 10
        tt0 = generate_random_tensor(n, [2, 3])
        tt_list = tt.time_functions.split_single_step(tt0)
        ...
        tt_list = tt.time_functions.split_single_step(tt1)
